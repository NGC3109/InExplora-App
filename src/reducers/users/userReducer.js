...
import { SAVE_USER, PREPARE_TO_CREATE, DISPLAYNAME_TO_CREATE, GET_USER, CLEAR_USER, UPDATE_FOLLOWERS_COUNT, GET_USER_BY_ID } from "../../utils/constants";

const userReducer = (state = initialState, action) => {
    switch (action.type) {
      case SAVE_USER: return { ...state, user: action.payload, };
      case GET_USER: return { ...state, user: action.payload,};
      case GET_USER_BY_ID: return { ...state, userPublic: action.payload,};
